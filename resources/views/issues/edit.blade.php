<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-slate-900">Edit Issue</h2>
            ...
            <div class="surface-card p-6 md:p-8">
                <form method="POST" action="{{ route('issues.update', $issue) }}" class="space-y-6">
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <button type="submit" class="rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800">Update Issue</button>
                    </div>
                </form>
            </div>
        </div>
